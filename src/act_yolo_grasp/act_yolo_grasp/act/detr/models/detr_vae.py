...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, obs_dim, action_dim, num_queries, camera_names, sep_CNN=None):
...
def build(args):
    ...
    print("number of parameters: %.2fM" % (num_parameters / 1e6,))
